...
<head>
    ...
    <title>Registe   Page - Vuexy - Bootstrap HTML admin template</title>
                    ...
                    <div class="auth-inner py-2">
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                ...
                                <h4 class="card-title mb-1">Selamat Datang di KiePhoto</h4>
                                <p class="card-text mb-2">Silahkan Register untuk membuat akun baru</p>
                                @if (session('success'))
                                ...
                                <form action="{{route('proses-register')}}" method="post">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <input type="nama_lengkap" class="form-control " id="nama_lengkap" name="nama_lengkap" placeholder="Masukkan nama_lengkap anda">
                                  </div>
                                  <div class="form-group">
                                      <label>Email</label>
                                  ...
                                  <div class="form-group">
                                      <label>Alamat</label>
                                      <input type="alamat" class="form-control " id="alamat" name="alamat" placeholder="Masukkan alamat anda">
                                  </div>

                                  <div class="form-group">
                                      <label>No Telepon</label>
                                      <input type="no_telp" class="form-control " id="no_telp" name="no_telp" placeholder="Masukkan no_telp anda">
                                  </div>
